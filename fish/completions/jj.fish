...
function __fish_jj_global_optspecs
	string join \n R/repository= ignore-working-copy no-integrate-operation ignore-immutable at-operation= debug color= quiet no-pager config= config-file= google3-flag= h/help V/version
end
...
complete -c jj -n "__fish_jj_needs_command" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_needs_command" -f -a "bug-report" -d 'Write debugging information to a Buganizer issue'
complete -c jj -n "__fish_jj_needs_command" -f -a "daemon" -d 'Commands for interacting with the jj-daemon directly'
complete -c jj -n "__fish_jj_needs_command" -f -a "screensaver" -d 'Display an animated rendition of jj'
complete -c jj -n "__fish_jj_needs_command" -f -a "piper" -d 'Commands for interacting with jj-on-Piper repos'
complete -c jj -n "__fish_jj_needs_command" -f -a "vcslib" -d 'Commands for vcslib to get info from'
...
complete -c jj -n "__fish_jj_using_subcommand abandon" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand absorb" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand arrange" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bisect; and not __fish_seen_subcommand_from run" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bisect; and __fish_seen_subcommand_from run" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and not __fish_seen_subcommand_from advance a create c delete d forget f list l move m rename r set s track t untrack" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from advance" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from a" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from create" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from c" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from delete" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from d" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from forget" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from f" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from list" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from l" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from move" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from m" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from rename" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from r" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from set" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from s" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from track" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from t" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bookmark; and __fish_seen_subcommand_from untrack" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand commit" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and not __fish_seen_subcommand_from edit e gc get g list l path p set s unset u" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from edit" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from e" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from gc" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from get" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from g" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from list" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from l" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from path" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from p" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from set" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from s" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from unset" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand config; and __fish_seen_subcommand_from u" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and not __fish_seen_subcommand_from copy-detection fileset index index-changed-paths init-simple local-working-copy object reindex revset snapshot stacked-table template tree watchman working-copy" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from copy-detection" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from fileset" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from index" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from index-changed-paths" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from init-simple" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from local-working-copy" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from object" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from reindex" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from revset" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from snapshot" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from stacked-table" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from template" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from tree" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from watchman" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand debug; and __fish_seen_subcommand_from working-copy" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand describe" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand diff" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand diffedit" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand duplicate" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand edit" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand evolog" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand evolution-log" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and not __fish_seen_subcommand_from annotate chmod list search show track untrack" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from annotate" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from chmod" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from list" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from search" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from show" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from track" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand file; and __fish_seen_subcommand_from untrack" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand fix" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand gerrit; and not __fish_seen_subcommand_from upload" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand gerrit; and __fish_seen_subcommand_from upload" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and not __fish_seen_subcommand_from clone colocation export fetch import init push remote root" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from clone" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from colocation" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from export" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from fetch" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from import" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from init" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from push" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from remote" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand git; and __fish_seen_subcommand_from root" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand help" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand interdiff" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand log" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand metaedit" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand new" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand next" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and not __fish_seen_subcommand_from abandon diff integrate log restore revert show" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from abandon" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from diff" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from integrate" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from log" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from restore" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from revert" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from show" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and not __fish_seen_subcommand_from abandon diff integrate log restore revert show" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from abandon" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from diff" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from integrate" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from log" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from restore" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from revert" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand op; and __fish_seen_subcommand_from show" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand parallelize" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand prev" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand rebase" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand redo" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand resolve" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand restore" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand revert" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand root" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand run" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand show" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand sign" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand simplify-parents" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand sparse; and not __fish_seen_subcommand_from edit list reset set" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand sparse; and __fish_seen_subcommand_from edit" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand sparse; and __fish_seen_subcommand_from list" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand sparse; and __fish_seen_subcommand_from reset" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand sparse; and __fish_seen_subcommand_from set" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand split" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand squash" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand status" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and not __fish_seen_subcommand_from delete d list l set s" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and __fish_seen_subcommand_from delete" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and __fish_seen_subcommand_from d" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and __fish_seen_subcommand_from list" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and __fish_seen_subcommand_from l" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and __fish_seen_subcommand_from set" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand tag; and __fish_seen_subcommand_from s" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand undo" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand unsign" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and not __fish_seen_subcommand_from backend completion config-schema exec gc install-man-pages markdown-help snapshot" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from backend" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from completion" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from config-schema" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from exec" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from gc" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from install-man-pages" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from markdown-help" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand util; and __fish_seen_subcommand_from snapshot" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand version" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and not __fish_seen_subcommand_from add forget list rename root update-stale" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and __fish_seen_subcommand_from add" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and __fish_seen_subcommand_from forget" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and __fish_seen_subcommand_from list" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and __fish_seen_subcommand_from rename" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and __fish_seen_subcommand_from root" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand workspace; and __fish_seen_subcommand_from update-stale" -l google3-flag -d 'Flags to pass into C++' -r
...
complete -c jj -n "__fish_jj_using_subcommand bug-report" -s b -l bug -d 'Buganizer issue number' -r
complete -c jj -n "__fish_jj_using_subcommand bug-report" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand bug-report" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand bug-report" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -f -a "kill" -d 'Terminate the local daemon for testing purposes'
complete -c jj -n "__fish_jj_using_subcommand daemon; and not __fish_seen_subcommand_from kill resume" -f -a "resume" -d 'Lift a daemon permanent-error lockdown'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from kill" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand daemon; and __fish_seen_subcommand_from resume" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l dimensions -d 'Visualize jj in the given number of spatial dimensions' -r
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l redundancy -d 'Provision the given number of js before beginning' -r
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l colors -d 'The amount of distinct colors used' -r -f -a "less\t''
some\t''
more\t''"
complete -c jj -n "__fish_jj_using_subcommand screensaver" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l jello -d 'Enhances wobbliness'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand screensaver" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "citc" -d 'Commands for interacting with JJ on CitC workspaces'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "clone-repo" -d 'Create a copy of a user\'s repo'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "cls" -d 'Commands for interacting with CL metadata'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "copy" -d 'Copy a file/directory to another path'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "jjd" -d 'Navigate to a Jj-on-CitC workspace by alias or CL number'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "lint" -d 'Show linter findings for commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "localdisk" -d 'Commands for interacting with JJ on localdisk workspaces'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "mail" -d 'Mail CLs to specified reviewers'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "patch" -d 'Patch change(s) from Piper into the workspace'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "presubmit" -d 'Presubmit CLs and their diffbases to Piper'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "pull" -d 'Fast-forward `main`/`p4head` to the latest indexed Piper CL'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "rename" -d 'Rename a file/directory to another path'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "repo" -d 'Commands for interacting with jj-on-Piper repositories'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "upload" -d 'Export commit(s) to Critique as Changelist(s)'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "upload-all" -d 'Export all pending commits to Critique as Changelists'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "upload-exported" -d 'Export all commits that have already been uploaded to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "submit" -d 'Submit CLs and their diffbases to Piper'
complete -c jj -n "__fish_jj_using_subcommand piper; and not __fish_seen_subcommand_from citc clone-repo cls copy jjd lint localdisk mail patch presubmit pull rename repo upload upload-all upload-exported submit sync" -f -a "sync" -d 'Fast-forward `main`/`p4head` to the latest indexed Piper CL and rebase commits on top of it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "branch" -d 'Commands for interacting with branches in jj-on-CitC workspaces'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "delete" -d 'Delete an existing jj-on-Piper CitC workspace and repo'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "fix-view-config" -d 'Fix an out-of-sync ViewConfig that is preventing snapshotting'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "init" -d 'Create a new CitC workspace for jj-on-Piper'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "list" -d 'List all jj-on-CitC workspaces'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "undelete" -d 'Restore the alias for a previously deleted jj-on-CitC workspace'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "snapshot" -d 'Create a CitC snapshot from a revision'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from citc" -f -a "workspace" -d 'Command for interacting with JJ-on-CitC working copies within a repo'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l username -d 'The source repo owner\'s username' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l repo-id -d 'The source repo id' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l operation-id -d 'The id of the operation to use as head in the new repo' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l workspace-name -d 'The name of the workspace in the source repo to use for the new workspace. Required if the repo has more than one workspace' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from clone-repo" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -f -a "drop" -d 'Drop and abandon a set of CLs from piper'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -f -a "rollback" -d 'Roll back one or more submitted Piper CLs'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from cls" -f -a "tags" -d 'Commands for interacting with CL metadata'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -s r -l revision -d 'Record the copy in this revision' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -s A -l after -d 'Record copy that already occurred'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -s F -l forget -d 'Forget the recorded copy'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from copy" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l checkout -d 'Whether to checkout a CL in jj if not already checked out' -r -f -a "prompt\t''
yes\t''
no\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l branch -d 'The development branch (e.g. spanner_development_branch) to use' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -s f -l force -d 'Create the specified workspace if it does not exist'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l piper -d 'Navigate to the Piper client instead of the jj repo'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from jjd" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -s r -l revisions -d 'The revisions whose new linter findings are shown. Each revision will be compared to its own parent revision, and findings already present in the parent revision will be omitted' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from lint" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -f -a "init" -d 'Initialize a new jj-on-Piper repo on local disk'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from localdisk" -f -a "workspace" -d 'Commands for interacting with JJ on localdisk working copies'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s r -l revisions -d 'Commits to mail' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s m -l reviewers -d 'Reviewers to send the CLs to' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s z -l cc -d 'Reviewers to CC the CLs to' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l tap-projects -d 'Specific TAP projects to run' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l filter -d 'Regexp filter on presubmit tests to run' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s b -l bugids -d 'Bugs to add to BUG= tag' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s x -l fixed-bugs -d 'Bugs to add to FIXED= tag' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s i -l interactive -d 'Open the editor even if reviewers are specified'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l lucky -d 'Mail to the top suggestion from SuggestReviewers'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l disable-review-notify -d 'Disable review_notify on mail'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l autosubmit -d 'Enable autosubmit on mail'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l autosync -d 'Enable autosync on submit. Implies `--autosubmit`'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s n -l display-only -d 'Only display presubmits that would run, don\'t actually mail or submit'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l ignore-presubmit-warnings -d 'Ignore presubmits with the WARNING status'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l ignore-presubmit-errors -d 'Ignore presubmits with the ERROR status'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l disable-presubmits -d 'Skip presubmits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l upload-empty-merges -d 'This flag only controls the upload of empty merge commits with no children. If true, empty merge commits with a description are uploaded; those without a description are not. If false, empty merge commits are not uploaded'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s p -l publish-comments -d 'Publish draft comments to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l no-snapshot-in-critique -d 'Don\'t upload contents to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l overwrite-remote-changes -d 'Overwrite uploaded changes if necessary'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l remail -d 'Mail CLs even if they have already been mailed'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l find-reviewers -d 'Use Piper\'s SuggestReviewers feature to recommend appropriate reviewers'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s d -l detach -d 'Mail CLs in the background on the server, freeing the command line'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s j -l parallel -d 'Mail CLs in parallel where not dependent upon each other'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l eager -d 'Mail CLs in parallel eagerly even when dependent upon each other'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from mail" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -s c -l change -d 'The change to patch' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l no-new-working-copy -d 'Do not create a new working copy on top of the patched change'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l no-adopt -d 'Create only untracked remote bookmark for the CL even if authored by the importer'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -s d -l duplicate -d 'Ignore existing CL associations and import this CL as a new change'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l squash-diffbases -d 'Imports a commit chain as a single commit, as if the commit and all of its diffbases had been squashed together'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l allow-backwards-sync-points -d 'Piper clients contain sync state for the entire client and for every file within the client. This permits states where a client is synced to CL Y but one or more files within the client are synced to CL X < Y. This particular state cannot be represented in JJ, which has no concept of per-file sync state. It is therefore impossible to `jj patch` such CLs without losing information. Normally such CLs are rejected during patch, but you can specify `--allow-backwards-sync-points` to allow them to be patched. This will put those files exactly as in the pending CL, effectively ignoring every change to them between X and Y'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from patch" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s r -l revisions -d 'Commits to presubmit' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l tap-projects -d 'Specific TAP projects to run' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l filter -d 'Regexp filter on presubmit tests to run' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s b -l bugids -d 'Bugs to add to BUG= tag' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s x -l fixed-bugs -d 'Bugs to add to FIXED= tag' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s a -l action -d 'Whether to presubmit the CL(s) as for review, or for submit' -r -f -a "mail\t''
review\t''
submit\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l autosync -d 'Enable autosync before submit'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l upload-empty-merges -d 'This flag only controls the upload of empty merge commits with no children. If true, empty merge commits with a description are uploaded; those without a description are not. If false, empty merge commits are not uploaded'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s p -l publish-comments -d 'Publish draft comments to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l no-snapshot-in-critique -d 'Don\'t upload contents to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l overwrite-remote-changes -d 'Overwrite uploaded changes if necessary'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s d -l detach -d 'Process CLs in the background on the server, freeing the command line'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s j -l parallel -d 'Process CLs in parallel where not dependent upon each other'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s n -l display-only -d 'Only display presubmits that would run, don\'t actually mail or submit'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l ignore-presubmit-warnings -d 'Ignore presubmits with the WARNING status'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l ignore-presubmit-errors -d 'Ignore presubmits with the ERROR status'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l disable-presubmits -d 'Skip presubmits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l eager -d 'Whether to presubmit the CLs in parallel without waiting for diffbases'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from presubmit" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l cl -d 'The CL to sync to, or the latest indexed Piper CL if not specified' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from pull" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -s r -l revision -d 'Record the copy in this revision' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -s A -l after -d 'Record copy that already occurred'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -s F -l forget -d 'Forget the recorded copy'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from rename" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -f -a "delete-alias" -d 'Delete the repo alias association for the specified alias'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -f -a "export" -d 'Export the local commits in this repo to a file'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -f -a "import" -d 'Import commits into this repo from a file'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -f -a "info" -d 'Displays the information needed for cloning the repo using `jj piper clone-repo`'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -f -a "list" -d 'List all repos owned by the user'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from repo" -f -a "set-alias" -d 'Set the commit-cloud alias for a specific repo, overwriting any existing alias'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -s r -l revisions -d 'Commits in flag form' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -s a -l all -d 'Upload all revisions'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l exported -d 'Upload all previously exported (uploaded) revisions, ignoring conflicted commits and their descendants'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l upload-empty-merges -d 'This flag only controls the upload of empty merge commits with no children. If true, empty merge commits with a description are uploaded; those without a description are not. If false, empty merge commits are not uploaded'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -s p -l publish-comments -d 'Publish draft comments to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l no-snapshot-in-critique -d 'Don\'t upload contents to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l overwrite-remote-changes -d 'Overwrite uploaded changes if necessary'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l upload-empty-merges -d 'This flag only controls the upload of empty merge commits with no children. If true, empty merge commits with a description are uploaded; those without a description are not. If false, empty merge commits are not uploaded'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -s p -l publish-comments -d 'Publish draft comments to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l no-snapshot-in-critique -d 'Don\'t upload contents to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l overwrite-remote-changes -d 'Overwrite uploaded changes if necessary'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-all" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l upload-empty-merges -d 'This flag only controls the upload of empty merge commits with no children. If true, empty merge commits with a description are uploaded; those without a description are not. If false, empty merge commits are not uploaded'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -s p -l publish-comments -d 'Publish draft comments to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l no-snapshot-in-critique -d 'Don\'t upload contents to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l overwrite-remote-changes -d 'Overwrite uploaded changes if necessary'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from upload-exported" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s r -l revisions -d 'Commits to submit' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l tap-projects -d 'Specific TAP projects to run' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l filter -d 'Regexp filter on presubmit tests to run' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s b -l bugids -d 'Bugs to add to BUG= tag' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s x -l fixed-bugs -d 'Bugs to add to FIXED= tag' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l max-parallel-presubmits -d 'Maximum number of pre-emptive presubmits to run in parallel' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l autosync -d 'Enable autosync before submit'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l upload-empty-merges -d 'This flag only controls the upload of empty merge commits with no children. If true, empty merge commits with a description are uploaded; those without a description are not. If false, empty merge commits are not uploaded'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s p -l publish-comments -d 'Publish draft comments to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l no-snapshot-in-critique -d 'Don\'t upload contents to Critique'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l overwrite-remote-changes -d 'Overwrite uploaded changes if necessary'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s d -l detach -d 'Process CLs in the background on the server, freeing the command line'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s j -l parallel -d 'Process CLs in parallel where not dependent upon each other'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l ignore-presubmit-warnings -d 'Ignore presubmits with the WARNING status'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l ignore-presubmit-errors -d 'Ignore presubmits with the ERROR status'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l disable-presubmits -d 'Skip presubmits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l no-parallelism-check -d 'Ignore warnings about conflicting parallel submits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s n -l dry-run -d 'Test submitting the change without actually submitting it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from submit" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l cl -d 'The CL to sync to. Will sync to the latest indexed Piper CL if not specified' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -s b -l branches -d 'Specific branches to sync (can be repeated). Incompatible with `--all`' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -s a -l all -d 'Whether to sync all unsubmitted commits to the specified head'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -s n -l none -d 'Sync no commits, only update `main`/`p4head`'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand piper; and __fish_seen_subcommand_from sync" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -f -a "get-diff-summary" -d 'Print diffs relevant to the working copy commit and parent'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -f -a "get-pending-change-number" -d 'Print the pending CL number for the "current commit"'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and not __fish_seen_subcommand_from get-diff-summary get-pending-change-number p4-client-info" -f -a "p4-client-info" -d 'Print blaze client info for Sponge'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l base-revision -d 'Revision to diff the working copy against. Uses p4base if unspecified' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l adds -d 'Whether to include adds in the list of diffs'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l modifies -d 'Whether to include modifications in the list of diffs'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l deletes -d 'Whether to include deletes in the list of diffs'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l skip-conflicts -d 'Whether to omit conflicted files from the list of diffs'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-diff-summary" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from get-pending-change-number" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l google3-flag -d 'Flags to pass into C++' -r
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand vcslib; and __fish_seen_subcommand_from p4-client-info" -s h -l help -d 'Print help (see more with \'--help\')'
